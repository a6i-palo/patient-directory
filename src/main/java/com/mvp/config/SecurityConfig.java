...
import com.mvp.auth.SecurityFilter;
import com.mvp.auth.models.SecurityProperties;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  @Autowired SecurityProperties restSecProps;

  @Autowired public SecurityFilter tokenAuthenticationFilter;
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http.cors()
        ...
        .and()
        .authorizeRequests()
        .antMatchers(restSecProps.getAllowedPublicApis().toArray(String[]::new))
        .permitAll()
